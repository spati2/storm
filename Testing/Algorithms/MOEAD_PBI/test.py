...
def problems_runner(list_args):
    ...
    tests = jmoo_test(problems, algorithms_PBI)
    IGD_Results = []
    for problem in tests.problems:
        ...
        for algorithm in tests.algorithms:
            ...
            filename = "./Testing/Algorithms/MOEAD_PBI/Results/" + str(problem.name) + ".txt"
            f = open(filename, "w")
...
problems = [
    ...
    [dtlz2(12, 3), 91, 250], [dtlz1(7,3), 91, 400], [dtlz1(9, 5), 210, 600], [dtlz1(12, 8), 156, 750], [dtlz1(14, 10), 275, 1000], [dtlz1(19, 15), 135, 1500],
    [dtlz2(14, 5), 210, 350], [dtlz2(17, 8), 156, 500], [dtlz2(19, 10), 275, 750], [dtlz2(24, 15), 135, 1000],
